   ...
   private void createUIListenersTreeViewer() {
    ...
    private void createUIListenersFilterText() {
        ...
        filterText.addKeyListener(new KeyListener() {
            public void keyPressed(final KeyEvent e) {
                System.out
                        .println("QuickOutlinePopupDialog.createUIListenersFilterText().new KeyListener() {...}.keyPressed(" + e + ")");
                if (e.keyCode == 0x0D) {
    ...
    private void insertSelectedElement() {
        ...
        System.out.println("QuickOutlinePopupDialog.insertSelectedElement(" + selectedElement + ")");
